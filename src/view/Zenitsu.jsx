...
function Zenitsu() {
  return (
    <div
      className="relative flex flex-col min-h-screen lg:pt-[150px]"
      // style={{
      //   backgroundImage: `url(${zenitsu2})`,
      //   backgroundSize: 'cover',
      //   backgroundPosition: 'center',
      //   backgroundRepeat: 'no-repeat',  // Opacité de fond
      // }}
    >
      ...
      <div className="relative flex flex-col text-center">
        ...
        <div className='flex flex-row pt-10 space-x-7'>
          <div className="text-[12px] lg:text-[15px] lg:max-w-lg text-left pl-4">
          ...
          <div className='flex flex-col pt-[120px] text-[12px] text-left lg:text-[15px] lg:max-w-lg'>
            ...
            <div className='flex flex-row space-x-1 '>
              <video 
                ...
                muted 
                playsInline
                className='lg:w-[400px] h-auto mt-4'
              ></video>
              <img 
                src={world} 
